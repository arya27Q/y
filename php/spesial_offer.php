...
// 2. Ambil semua data promo dari database
$query_offers = mysqli_query($conn, "SELECT * FROM special_offers");
?>
...
<body id="top"> <header>
  ...
  <div class="offers">
    <?php 
    // --- MULAI LOOPING PROMO ---
    while($offer = mysqli_fetch_assoc($query_offers)) { 
    ?>
      
      <div class="offer-card <?php echo $offer['category']; ?>">
        
        <img src="../img/<?php echo $offer['gambar']; ?>" alt="<?php echo $offer['judul']; ?>">
        
        <h2><?php echo $offer['judul']; ?></h2>
        
        <p><?php echo $offer['deskripsi']; ?></p>
        
        <a href="reservasi_hotel.php?promo_code=<?php echo $offer['promo_code']; ?>" class="btn">Book Now</a>
